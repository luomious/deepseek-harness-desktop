window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			...
			tag.textContent = css + ".ZuhsRW_nativePickerButton{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2)}.ZuhsRW_upButton{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;align-items:center;justify-content:center;width:24px;height:22px;padding:0;display:inline-flex}.ZuhsRW_upButton:disabled{opacity:.4}";
		...
		*/
		function DirectoryBrowser({ open, listDirectory, createDirectory, pickNativeDirectory, validateDirectory, onOpen, onClose, busy, t }) {
			...
			*/
			...
			const parentPath = parent === null || parent.path === null || parent.path === "" ? null : (() => {
				const sep = separatorOf(parent);
				let value = parent.path;
				if (value.endsWith(sep)) value = value.slice(0, -1);
				const cut = value.lastIndexOf(sep);
				return cut === -1 ? null : value.slice(0, cut + 1);
			})();
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("h2", {
								...
								children: pathDraft === null ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
									...
									type: "button",
									className: DirectoryBrowser_module_css_default.upButton,
									"aria-label": t("browser.up"),
									title: t("browser.up"),
									disabled: parentInert || parentPath === null,
									onClick: () => {
							...
							children: [
								...
								pickNativeDirectory !== void 0 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
									...
									children: (0, react_jsx_runtime.jsx)("button", {
										...
										children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpen16, { size: 16 })
									})
								}),
