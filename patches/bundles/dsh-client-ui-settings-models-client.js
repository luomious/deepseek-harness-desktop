window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		// dsh-desktop patch: model-catalog search — substring filter by name/id, keeping the original row index
		function filterModels(models, query) {
			const q = String(query ?? "").trim().toLowerCase();
			if (q.length === 0) return models.map((model, index) => ({ model, index }));
			return models.map((model, index) => ({ model, index })).filter(({ model }) => String(model?.name ?? "").toLowerCase().includes(q) || String(model?.id ?? "").toLowerCase().includes(q));
		}
		function DeepSeekModelsEditor(props) {
			const [editing, setEditing] = (0, react.useState)(() => /* @__PURE__ */ new Map());
			const [expanded, setExpanded] = (0, react.useState)(() => /* @__PURE__ */ new Set());
			const [catalogQuery, setCatalogQuery] = (0, react.useState)("");
			const catalogView = filterModels(props.models, catalogQuery);
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					props.models.length > 0 ? (0, react_jsx_runtime.jsx)("div", {
					...
					}) : catalogQuery.trim().length > 0 && catalogView.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
						className: ModelsSection_module_css_default["modelEmpty"],
						children: props.t("modelsSearchEmpty")
					}) : (0, react_jsx_runtime.jsx)("div", {
						className: ModelsSection_module_css_default["modelList"],
						children: catalogView.map(({ model, index }) => (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		function ModelListEditor(props) {
			...
			const [expanded, setExpanded] = (0, react.useState)(/* @__PURE__ */ new Set());
			const [editing, setEditing] = (0, react.useState)(/* @__PURE__ */ new Map());
			const [pickQuery, setPickQuery] = (0, react.useState)(""); // dsh-desktop patch: fetch-dialog search
			const pickQ = pickQuery.trim().toLowerCase();
			const pickView = pickQ.length === 0 ? (candidates ?? []) : (candidates ?? []).filter((candidate) => String(candidate.name ?? "").toLowerCase().includes(pickQ) || String(candidate.id ?? "").toLowerCase().includes(pickQ));
			const [catalogQuery, setCatalogQuery] = (0, react.useState)("");
			const catalogView = filterModels(models, catalogQuery);
			...
			const fetchModels = async () => {
				...
				try {
					...
					setCandidates(found);
					setPickQuery("");
					setPicked(/* @__PURE__ */ new Set()); // dsh-desktop patch: fetch-dialog default none
				} catch (error) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					}) : catalogView.map(({ model, index }) => (0, react_jsx_runtime.jsxs)("div", {
						className: ModelsSection_module_css_default["modelEntry"],
						children: [(0, react_jsx_runtime.jsxs)("div", {
							className: ModelsSection_module_css_default["modelRow"],
							children: [
					...
					(0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						...
						}), pickQ.length > 0 && pickView.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
							className: ModelsSection_module_css_default["modelEmpty"],
							children: t("modelsSearchEmpty")
						}) : (0, react_jsx_runtime.jsx)("ul", {
							className: ModelsSection_module_css_default["candidateList"],
							children: pickView.map((candidate) => (0, react_jsx_runtime.jsx)("li", {
