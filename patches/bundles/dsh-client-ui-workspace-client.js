window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, useDirectoryFlow, renderDirectoryFlow, renderRemoteFlow, startChatSession, onPick, onClose, addOnly = false, side = "bottom", selectedId }) {
		...
		*/
		function WorkspacePicker({ open, anchorRef, useWorkspaces, selectedId, onPick, onClose, createWorkspace, startChatSession, useDirectoryFlow, renderSlot, renderRemoteFlow, t }) {
